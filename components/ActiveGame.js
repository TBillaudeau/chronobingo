  ...
  if (game.status === 'finished') {
      ...
      return (
          <div className="min-h-screen flex flex-col items-center p-4 animate-pop">
              <div className="fixed inset-0 pointer-events-none z-0 flex items-center justify-center opacity-50">
    ...
    <div className="w-full max-w-md mx-auto pb-20 relative min-h-screen flex flex-col">
      ...
      {selectedCellId && (
        <div className="fixed inset-0 z-50 flex items-end md:items-center justify-center sm:p-4 animate-in fade-in duration-200">
            ...
            {/* Modal Content */}
            <div className="relative w-full max-w-lg h-[90vh] md:h-[80vh] bg-slate-900/60 backdrop-blur-2xl border border-white/10 shadow-[0_0_50px_rgba(0,0,0,0.5)] rounded-t-3xl md:rounded-3xl flex flex-col overflow-hidden animate-slide-up">
