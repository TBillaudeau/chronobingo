...
const ActiveGame = ({ initialGame, currentUser, lang, onGameUpdate, onLeave, onNavigateToProfile }) => {
    ...
    return (
        <div className="w-full max-w-md mx-auto pb-4 relative min-h-dvh flex flex-col">
            ...
            {showBatteryWarning && (
                <div className="fixed top-0 left-0 w-full z-[100] bg-gradient-to-r from-red-600 to-orange-600 text-white text-[10px] font-bold pb-2 px-4 pt-[calc(0.5rem+env(safe-area-inset-top))] text-center shadow-xl animate-slide-down border-b border-white/20">
            ...
            <header className="flex justify-between items-center relative z-40 mb-4 mt-[calc(1rem+env(safe-area-inset-top))] mx-2 md:mx-4 p-2 md:p-3 rounded-3xl glass-liquid transition-all">
